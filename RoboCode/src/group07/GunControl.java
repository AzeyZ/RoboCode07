...
public class GunControl {
	...
	private AllyTracker ally;
	 /**
	  * 
	  * @param ally Instance of our allyTracker
	  */
	public GunControl(AllyTracker ally) {
	  ...
	  * @param target Instance of our enemybot
	  * @return takeShot checks if it's good to shoot, true = shoot, false = do not shoot.
	  */
	public boolean takeShot(MrRobot robot, EnemyBot target) {
	 ...
	 /**
	  * Calculates if target is within 900 pixles and checks if we can turn the gun towards them in the given time.
